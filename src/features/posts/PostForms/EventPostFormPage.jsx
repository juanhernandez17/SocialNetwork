...
// Import our modules
import { createEventPost, updateEventPost, cancelToggle } from '../postActions';
...
class EventPostForm extends Component {
  state = {
    cityLatLng: {},
    venueLatLng: {},
    scriptLoaded: false
  ...
  onFormSubmit = values => {
    ...
    if (this.props.initialValues.id) {
      ...
      this.props.updateEventPost(values);
      this.props.history.goBack();
    } else {
      this.props.createEventPost(values);
    ...
    <div>
      <Grid>
        ...
        <Grid.Column width={10}>
          <Segment>
            <Header sub style={greenTextStyle} content="Event Details" />
            <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
              ...
              />
              <Header sub style={greenTextStyle} content="Event Location details" />
              <Field
                name="city"
                type="text"
